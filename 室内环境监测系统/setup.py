...
def setup_db():
    ...
    if cur.fetchall()[0][0] == 0:
        cur.execute('INSERT INTO sensorlist(sensorid,sensorname,maxvalue,minvalue) VALUES(1,"温度传感器",40,0)')
    ...
    if cur.fetchall()[0][0] == 0:
        cur.execute("INSERT INTO sensorlog(logid,sensorid,sensorvalue,updatetime) VALUES(1,1,29,'%s')"%now)
        db.commit()
